...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-primary/90 shadow-[var(--shadow-gold)] hover:shadow-[var(--glow-gold)]",
        destructive:
        ...
        luxury:
          "bg-gradient-to-r from-[hsl(45,85%,55%)] to-[hsl(45,75%,65%)] text-primary-foreground hover:shadow-[var(--glow-gold)] hover:scale-105",
      },
      size: {
...
const ButtonLuxury = React.forwardRef<HTMLButtonElement, ButtonProps>(
...
export { ButtonLuxury, buttonVariants };
